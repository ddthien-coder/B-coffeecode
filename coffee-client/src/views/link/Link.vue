<template>
  <div>
    ...
    <div class="link-banner banner">
      <h1 class="banner-title">Friendly link</h1>
    </div>
    <!-- Link list -->
    <v-card class="blog-container">
      <div class="link-title mb-1">
        <v-icon color="blue">mdi-link-variant</v-icon> Variant link
      </div>
      ...
      <div class="link-title mt-4 mb-4">
        <v-icon color="blue">mdi-dots-horizontal-circle</v-icon> Add friend chain
      </div>
      <blockquote>
        <div>Name: CoffeCode blog</div>
        <div>Introduction: It depends on the people and the sky.</div>
      </blockquote>
      <div class="mt-5 mb-5">
        Those who need to exchange friend chains can leave a message below💖
      </div>
      <blockquote class="mb-10">
        Friends chain information display needs, your information format should include: name, introduction, link, avatar
      </blockquote>
      <!-- Comment -->
