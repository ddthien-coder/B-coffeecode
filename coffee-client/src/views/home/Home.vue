    ...
    <div class="home-banner">
      <div class="banner-container">
        ...
        <div class="blog-contact">
          <a
            target="_blank"
            href="https://github.com/Ivanluca"
          ...
          <v-card class="blog-card animated zoomIn mt-5">
            ...
            <div class="web-info">
              <div style="padding:4px 0 0">
                Running time: <span class="float-right">{{ time }}</span>
              </div>
              <div style="padding:4px 0 0">
                Total visits: <span class="float-right">
                  {{ blogInfo.viewsCount }}
                </span>
              </div>
            </div>
...
// Initialize
    // init() {
    //   // One word Api for typewriter loop output effect
    ...
    runTime() {
      var timeold =
        new Date().getTime()-new Date("March 15,2021").getTime();
      var msPerDay = 24 * 60 * 60 * 1000;
      var daysold = Math.floor(timeold / msPerDay);
      var str = "";
      var day = new Date();
      str += daysold + "Day";
      str += day.getHours() + "Hour";
